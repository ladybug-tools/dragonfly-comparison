...
latex_documents = [
    (master_doc, 'dragonfly-comparison.tex', 'dragonfly-comparison Documentation',
...
man_pages = [
    (master_doc, 'dragonfly-comparison', 'dragonfly-comparison Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dragonfly-comparison', 'dragonfly-comparison Documentation',
     author, 'dragonfly-comparison', 'One line description of project.',
     'Miscellaneous'),
]
...
def write_cli_files(group_filenames, lib_name, tool_name, doc_folder):
    ...
    Args:
        ...
        lib_name: The name of the library the click groups belong to. For
            example ``honeybee_comparison``, ``dragonfly`` or ``honeybee_comparison``
            are possible library names.
        tool_name: The command line tool name for the specified library. For
            instance ``honeybee-comparison`` is the CLI tool used for the
            honeybee_comparison library.
